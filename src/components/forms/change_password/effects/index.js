...
export const useHandleChangePasswordComponentEffects = (componentState, component) => {
  ...
  useEffect(() => {
    handlePasswordComparisonAction(  
      componentState?.query?.newPassword,
      componentState?.query?.confirmNewPassword,
      "confirmNewPassword",
      componentState?.setFieldError)
